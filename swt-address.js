...
// 💡 IDEA (Peerapat 2026-07-26 · ทำทีหลัง — ใช้กับการกรอกที่อยู่ทุกที่):
//   ค้นที่อยู่แบบ dropdown autocomplete — พิมพ์รหัสไปรษณีย์/ตำบล → แสดง "รายการที่อยู่ไทยที่ตรง"
//   เป็น dropdown (เช่น "งิ้วด่อน เมืองสกลนคร สกลนคร 47000") → เลือก 1 บรรทัด →
//   เติม ตำบล/อำเภอ/จังหวัด/รหัสไปรษณีย์ อัตโนมัติครบ 4 ช่อง
//   ต้องต่อ dataset ตำบล-อำเภอ-จังหวัด-รหัสไปรษณีย์ ไทยจริง (กรมการปกครอง / ไปรษณีย์ไทย)
//   (ตอนนี้ POSTAL ด้านล่างเป็น sample เล็ก — ของจริงต้อง dataset เต็ม + UI dropdown เลือกได้)
