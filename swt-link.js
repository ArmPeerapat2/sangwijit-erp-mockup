...
(function () {
  ...
  var DOC_MAP = {
    ...
    VBL: 'po3-vendor-invoice-mockup.html',
    VINV: 'po3-vendor-invoice-mockup.html',
    REB: 'po-rebate-dashboard.html',
    // Warehouse
    GRN: 'wh1-grn-mockup.html',
    REC: 'wh1-grn-mockup.html',
    TRN: 'wh2-stock-transfer-mockup.html',
    TRF: 'wh2-stock-transfer-mockup.html',
    STK: 'wh3-stock-count-mockup.html',
    CNT: 'wh3-stock-count-mockup.html',
    GIS: 'whr-goods-issue-mockup.html',
    ISS: 'whr-goods-issue-mockup.html',
    // Service
    SVC: 'sv1-service-queue-mockup.html',
    SVQ: 'sv1-service-queue-mockup.html',
    SIN: 'sv2-service-invoice-mockup.html',
    SPR: 'sv3-spare-part-issue-mockup.html',
    WAR: 'sv4-warranty-check-mockup.html',
    JOB: 'sv5-job-card-mockup.html',
    // Finance
    RV: 'fi1-ar-receive-mockup.html',
    PAY: 'fi2-ap-payment-mockup.html',
    PV: 'fi2-ap-payment-mockup.html',
    TAX: 'fi3-tax-reconciliation-mockup.html',
    EXP: 'fi4-expense-wht-mockup.html',
    WHT: 'fi4-expense-wht-mockup.html',
    JV: 'fi13-dual-book-mockup.html',
    URC: 'fi1q-apply-queue-mockup.html',
    UAR: 'fi1q-apply-queue-mockup.html',
    // Delivery / Approval / etc.
    DLV: 'dl1-delivery-planning-mockup.html',
    DEL: 'dl1-delivery-planning-mockup.html',
    APV: 'ap1-approval-center-mockup.html',
    CLM: 'cl1-claims-mockup.html',
