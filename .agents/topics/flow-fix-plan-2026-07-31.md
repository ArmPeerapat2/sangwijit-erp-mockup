...
## 📄 spec/record — ❓ เคาะ (แก้เอกสาร)
| จุด | ปัญหา | ทำอะไร |
|---|---|---|
| PO_purchase.md 742 | ขัด 674 (GL ตอน Accrued vs Realized) | แก้ 742 ให้ตรง 674 (mockup ถูกแล้ว) |
| sanction วัน | record 60 · spec/mockup 30 | เคาะเลขจริง → sync |
| loaner | record WH-3 · sv1 WH-2R | เคาะ → sync |
| SV-7 scope | ซ่อมคืน vs +ส่งของขาย | เคาะ |
