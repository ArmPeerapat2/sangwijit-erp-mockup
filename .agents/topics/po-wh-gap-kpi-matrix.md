...
> ## ⛔ เอกสารนี้ล้าสมัยแล้ว — อ่านเพื่อดูประวัติเท่านั้น ห้ามใช้สั่งงาน (ปรับสถานะ 2026-07-21)
>
> เขียนไว้ 21 เม.ย. 2569 ก่อนการรวมหน้า 12 ก.ค. และก่อน grill คลัง 20-21 ก.ค. · **ตารางข้างล่างบอกให้สร้างหน้าที่ถูกตัดทิ้งไปแล้ว**
>
> **จุดที่ผิดแน่นอน:**
> - ❌ **"PO-5 ใบรับสินค้าฝั่งบัญชี (Finance GRN) = ขาด · P0 Critical ต้องสร้าง"** → **ผิด · ถูกตัดถาวรตั้งแต่ 8 มิ.ย. 2569** และ **ยืนยันซ้ำ 21 ก.ค.** ว่าไม่รื้อฟื้น
>   → กติกาปัจจุบัน: **ใบรับสินค้าของคลัง = เจ้าเดียวที่รับของ** · ฝ่ายบัญชีเข้าดูผ่าน**สิทธิ์ RBAC** ไม่ต้องมีหน้าแยก
> - ❌ "PO-8 บิลฝาก = ไม่มี mockup เลย" → **สร้างแล้ว** `po8-deposit-bill-mockup.html`
> - ❌ "PO-3 Vendor Onboarding ยังไม่ถูกสร้าง" → **ตัดทิ้งตั้งใจ** ตอนรวมหน้า 12 ก.ค. (อยู่ใน `_archive/`)
> - ⚠️ KPI ที่เขียนว่า "blocked — รอ PO-5" (P5, P14) → **ไม่ blocked** ดึงจากใบรับสินค้าของคลังได้เลย
>
> **ของจริงล่าสุดอยู่ที่ [[active.md]]** (บล็อก WH Audit + grill 2026-07-20/21)
