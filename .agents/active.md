...
- **📌 backlog: 5 มิติ (DOCGROUP/DEPARTMENT/PROJECT/ALLOCATE/SITE) hardcode ซ้ำ 4 หน้า** (sl3/sl4/slcn/sqt) — ควรทำ shared `swt-dimensions` component (reuse · ไม่ hardcode) · การชำระมี swt-payment.js แล้ว
