...
- **💰 ระบบราคา — grill เคาะโมเดล + เริ่ม build (Aราคา เสร็จ · B/C ต่อพรุ่งนี้):**
  ...
  - **⏳ ทำต่อพรุ่งนี้:** **Bราคา** = หน้าใหม่ `pm3-price-change-request` (ใบขอเปลี่ยนราคา + อนุมัติ CF-2.6 → ลง timeline) · **Cราคา** = ขายทันราคา SL-1/2/4 (resolve โปรฯ→กลุ่ม + snapshot ราคาตั้ง/ขายจริง/ลด ต่อบรรทัด + ล็อกที่ใบจอง)
