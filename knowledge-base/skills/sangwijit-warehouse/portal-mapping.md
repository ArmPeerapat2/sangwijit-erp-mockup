...
> ⚠️ **STALE — ตาราง WH mapping ด้านล่างไม่ตรงกับ spec ปัจจุบัน** (มี WH-2=GRN ซึ่งผิดตั้งแต่ก่อน renumber · WH-1=GRN จริง) · **ยึด `.claude/skills/sangwijit-portal/modules/WH_warehouse.md` + `.agents/topics/wh-renumber-plan.md` เป็นหลัก** — WH ปัจจุบัน: WH-1 รับ · WH-2 เบิก · WH-3 โอน · WH-4 นับ · ไฟล์นี้รอ reconcile รอบแยก
