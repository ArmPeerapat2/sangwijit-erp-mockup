  ...
  */
  var GROUPS = [
    ...
    {ico:'💼', label:'งานขาย (SL)', links:[
      ...
      ['PM5V','pm5-vat-simulator-mockup.html','PM-5 VAT Simulator (สอน Golden Rule)','old'],
    ...
    {ico:'🔧', label:'บริการ (SV)', links:[
      ...
      ['SVCK','sv-checklist-template-mockup.html','แบบฟอร์มเช็คลิสต์ ล้าง/ตรวจ','new'],
      ['SVMB','sv-tech-mobile-mockup.html','📱 หน้าจอมือถือช่างภาคสนาม','new'],
      ['SVTC','sv-tech-report-mockup.html','สรุปงานช่าง → ค่าแรง/ค่าคอม CM-1','new'],
      ['SVSLA','sv-sla-config-mockup.html','ตั้งค่าเวลามาตรฐาน SLA','new'],
      ['SVPD','sv-posted-docs-mockup.html','เอกสารบริการที่โพสต์แล้ว','new'],
    ...
    {ico:'⚙️', label:'ตั้งค่าระบบ (CF)', links:[
      ...
      ['CFBK','cf-bank-status-mockup.html','CF สถานะเชื่อมธนาคาร','new'],
