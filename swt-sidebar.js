...
(function(){
  ...
  var DONE = [
    'slq-sales-queue-mockup.html','bc365/sl1-quotation-mockup.html','sl2-reservation-mockup.html',
    ...
    'wh-q2-issue-queue-mockup.html','fiq-ar-finance-queue-mockup.html','fiq-ap-finance-queue-mockup.html',
    'wh2-issue-mockup.html','wh3r-transfer-request-mockup.html',
    'wh-q1-receive-queue-mockup.html',
    'wh2r-issue-request-mockup.html','wh4r-count-prep-mockup.html',
    'wh4-count-mockup.html','wh3-transfer-mockup.html',
    'fi1q-apply-queue-mockup.html',
    'slf1-credit-approval-mockup.html',
    'bc365/service-intake-mockup.html','bc365/service-board-mockup.html',
    'bc365/service-dispatch-mockup.html','bc365/service-parts-claim-mockup.html',
    'bc365/service-posted-docs-mockup.html','bc365/service-tech-mobile-mockup.html',
    'bc365/service-dashboard-mockup.html','bc365/service-setup.html',
    'bc365/service-item-master-mockup.html','bc365/service-contract-mockup.html',
    'md3-vendor-master-mockup-v3.html','md2-customer-master-mockup-v3.html',
    'bc365/item-master-mockup.html','bc365/employee-master-mockup.html',
    'bc365/cf1-position-master-mockup.html',
    'bc365/branch-master-mockup.html','bc365/warehouse-master-mockup.html',
    'bc365/cf3-payment-hub-mockup.html',
    'bc365/cf5-bank-master-mockup.html','bc365/cf2-1-tax-setup-mockup.html',
    'bc365/sv-sqt-quotation-mockup.html',
    'bc365/sc2-item-search-mockup.html',
    'bc365/cf2-6-approval-matrix-mockup.html',
    'bc365/cf2-7-doc-template-mockup.html',
  ...
  */
  var GROUPS = [
    ...
    {ico:'💼', label:'งานขาย (SL)', links:[
      ...
      ['SL-1','bc365/sl1-quotation-mockup.html','SL-1 ใบเสนอราคา (Unified · Item+Service+Charge)','new'],
    ...
    {ico:'📦', label:'คลังสินค้า (WH)', links:[
      ...
      ['WHQ1','wh-q1-receive-queue-mockup.html','WH-Q1 คิวรับสินค้า','old'],
      ['WHQ2','wh-q2-issue-queue-mockup.html','WH-Q2 คิวเบิกสินค้า','old'],
      ...
      ['WH3R','wh3r-transfer-request-mockup.html','WH-3R ใบขอโอน','old'],
    ...
    {ico:'💵', label:'บัญชี/การเงิน (FI)', links:[
      ['FIQAR','fiq-ar-finance-queue-mockup.html','FI-Q-AR คิวลูกหนี้','old'],
      ['FIQAP','fiq-ap-finance-queue-mockup.html','FI-Q-AP คิวเจ้าหนี้','old'],
    ...
    {ico:'🔧', label:'บริการ (SV)', links:[
      ['SV-IN','bc365/service-intake-mockup.html','SV-IN ใบรับงานซ่อม (7 แท็บ + 2-Gate + 🏭 Claim popup)','new'],
      ['SV-BD','bc365/service-board-mockup.html','SV-BD บอร์ดงานซ่อม (Kanban)','new'],
      ['SV-DP','bc365/service-dispatch-mockup.html','SV-DP Dispatch & Delivery','new'],
      ['SV-PC','bc365/service-parts-claim-mockup.html','SV-PC อะไหล่ & เคลม (core/consignment)','new'],
      ['SV-PD','bc365/service-posted-docs-mockup.html','SV-PD เอกสารบริการที่โพสต์แล้ว','new'],
      ['SV-MB','bc365/service-tech-mobile-mockup.html','SV-MB ช่างมือถือ (Technician)','new'],
      ['SV-DB','bc365/service-dashboard-mockup.html','SV-DB แดชบอร์ดบริการ (role-gate)','new'],
      ['SV-CF','bc365/service-setup.html','SV-CF ตั้งค่าบริการ','new'],
      ['SV-MA','bc365/service-contract-mockup.html','SV-MA สัญญาบำรุงรักษา (MA)','new'],
      ['SIR','sir-site-inspection-mockup.html','SIR ใบประเมินหน้างาน','old'],
      ['SQT','bc365/sv-sqt-quotation-mockup.html','SV-SQT ใบเสนอราคางานบริการ (BC365)','new'],
      ['SV-MF','bc365/service-menu-flow.html','SV-MF แผนผังเมนูบริการ','new'],
    ...
    {ico:'⚙️', label:'ตั้งค่าระบบ (CF)', links:[
      ['CF-1','bc365/cf1-position-master-mockup.html','CF-1 ทะเบียนตำแหน่ง (Position + RBAC)','new'],
      ...
      ['CF21','bc365/cf2-1-tax-setup-mockup.html','CF-2.1 Tax Setup (VAT + WHT Thai loc)','new'],
      ['CF22','cf2-2-number-series-mockup.html','CF-2.2 Running No.','old'],
      ['CF25','cf2-5-tech-template-mockup.html','CF-2.5 Template ช่าง','old'],
      ['CF26','bc365/cf2-6-approval-matrix-mockup.html','CF-2.6 Approval Matrix (12 WF · 6 tabs · CF-1 sync)','new'],
      ['CF27','bc365/cf2-7-doc-template-mockup.html','CF-2.7 Doc Template (22 doc · 3-pane · live preview)','new'],
      ['CF29','cf2-9-general-parameter-mockup.html','CF-2.9 ค่าตั้งต้น','old']]},
    {ico:'📚', label:'Master Data (MD)', links:[
      ['MD-1','bc365/item-master-mockup.html','MD-1 ทะเบียนสินค้า (BC365)','new'],
      ...
      ['MD-4','bc365/employee-master-mockup.html','MD-4 ทะเบียนพนักงาน','new'],
      ['MD5a','bc365/branch-master-mockup.html','MD-5a ทะเบียนสาขา','new'],
      ['MD5b','bc365/warehouse-master-mockup.html','MD-5b ทะเบียนคลัง','new'],
    ...
    {ico:'🧩', label:'Shared Components (SC)', links:[
      ...
      ['SC-2','bc365/sc2-item-search-mockup.html','SC-2 ค้นหาสินค้า (v2 · 3-type filter · 8-tab detail · 6 stock cols · FX)','new'],
